                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="/item"><i class="fa fa-amazon"></i> Item</a></li>
                            <li><a href="/invoice"><i class="fa fa-money"></i> Invoice</a></li>
                            <li><a href="/invoice_item"><i class="fa fa-usd"></i> Invoice Item</a></li>
                        </ul>
                    </div>
